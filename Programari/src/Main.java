...
public class Main {
    ...
    public static void main(String[] args) throws java.io.IOException { //saltamos excepciones
        // creamos la clase
        User user = new User();

        //creamos un objeto de la clase viewlogin
        ...
        // TODO: El paràmetre de la vista ViewObjective (numColumns: Seria el nombre de jugadors que hi ha a la partida)
